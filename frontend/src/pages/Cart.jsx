      ...
      <div>
        {cartData.map((item, index) => {
          const productData =
            ...
            defaultIndianFoodItems.find((product) => product._id === item._id);
          return (
            <div
              key={index}
            ...
            >
              <div className="flex items-start gap-6">
                <img
                  ...
                  src={productData?.image?.[0] || assets.logo}
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2 mt-2 sm:mt-0 sm:flex-row sm:items-center sm:gap-5">
                    <div>
                      <p>
                        {currency}
                        {productData?.price ?? 0}
                      ...
                      <p className="text-xs text-gray-400">
                        Qty: {item.quantity} &middot; Total: {currency}
